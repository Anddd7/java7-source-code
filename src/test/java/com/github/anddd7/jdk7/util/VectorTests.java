...
public class VectorTests {
  ...
  private static int hugeCapacity(int minCapacity) {
    ...
    return (minCapacity > AbstractCollectionTests.MAX_ARRAY_SIZE) ? Integer.MAX_VALUE : AbstractCollectionTests.MAX_ARRAY_SIZE;
  }
  ...
  private void grow(int minCapacity) {
    ...
    // 超界
    if (newCapacity - AbstractCollectionTests.MAX_ARRAY_SIZE > 0) {
